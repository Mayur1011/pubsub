...
struct Record{
    uint32_t recordOffsetDelta; // this will be added with record batch offset to get the actual record offset
...
// This will be store in .index file (Each partition will have a separate .index file)
struct SparseIndex {
